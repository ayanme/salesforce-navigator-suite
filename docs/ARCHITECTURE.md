...
- **Repository governance** (ownership matrix, routing rules, cross-domain routing, versioning policy, contributor guidance, vocabulary definitions, security policy) remains centralized in `PROJECT_STANDARD.md`.
...
Some Salesforce products span multiple official documentation domains. For these products, documentation ownership is distributed across the relevant Domain Navigators by documentation type — following the same domain-based routing principle above.

Products handled through cross-domain routing: **Agentforce**, **Data Cloud**, **Marketing Cloud Personalization**, **CRM Analytics**, and **MuleSoft**.

For the full routing table, see [PROJECT_STANDARD.md §7](../PROJECT_STANDARD.md).
...
4. **Cross-domain routing is defined in PROJECT_STANDARD.md §7.** Individual Navigator files do not repeat cross-domain routing assignments — they inherit them.
